...
IFontDisp = Font
__all__ = [ 'FONTSTRIKETHROUGH', 'Unchecked', 'OLE_XPOS_CONTAINER',
           'OLE_TRISTATE', 'LoadPictureConstants', 'IFontDisp',
           'OLE_YSIZE_CONTAINER', 'StdPicture', 'IPictureDisp',
           'Picture', 'OLE_XSIZE_HIMETRIC', 'Color', 'Default',
           'FONTSIZE', 'OLE_XPOS_PIXELS', 'FONTNAME', 'FONTBOLD',
           'IFont', 'OLE_XSIZE_PIXELS', 'OLE_YPOS_PIXELS',
           'OLE_YSIZE_PIXELS', 'Font', 'Gray', 'OLE_COLOR',
           'FontEvents', 'OLE_OPTEXCLUSIVE', 'OLE_YPOS_CONTAINER',
           'FONTITALIC', 'VgaColor', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_YSIZE_HIMETRIC', 'IPicture', 'FONTUNDERSCORE',
           'OLE_CANCELBOOL', 'Checked', 'OLE_HANDLE',
           'IFontEventsDisp', 'OLE_XPOS_HIMETRIC',
           'OLE_YPOS_HIMETRIC', 'OLE_XSIZE_CONTAINER', 'Monochrome',
           'StdFont']
